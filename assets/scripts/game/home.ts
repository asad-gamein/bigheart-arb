import { _decorator, Component, director, Node, Sprite, Label, SpriteFrame, AudioClip, AudioSource, VideoPlayer, VideoClip, tween, Button, Prefab, instantiate, ScrollView } from "cc";
...
let questionsEducation = [
    "ﻳﺴﺘﺤﻖ ﻛﻞ ﺍﻷﻃﻔﺎﻝ ﺍﻟﺬﻫﺎﺏ ﺇﻟﻰ ﺍﻟﻤﺪﺭﺳﺔ؟",
...
let questionsHealthCare = [
    "ﻳﻤﻜﻦ ﻷﻱ ﺷﺨﺺ ﺍﻟﺤﺼﻮﻝ ﻋﻠﻰ ﺍﻟﺪﻭﺍﺀ ﺍﻟﺬﻱ ﻳﺤﺘﺎﺟﻪ؟",
...
let questionsEmergency = [
    "ﺗﻘﺪﻡ ﻣﺆﺳﺴﺔ ﺍﻟﻘﻠﺐ ﺍﻟﻜﺒﻴﺮ ﺍﻟﺪﻋﻢ ﻓﻲ ﺣﺎﻻﺕ ﺍﻟﻄﻮﺍﺭﺉ؟",
...
let questionsLivlihood = [
    "ﺟﻤﻴﻊ الشباب ﻟﺪﻳﻬﻢ ﻭﻇﺎﺋﻒ؟",
...
export class Home extends Component {
    ...
    checkAnswer() {
        ...
        if (curAnswer === curAnswers[curQuestionNo]) {
            ...
            if (curAnswer === "N") this.noButton.node.active = false;
            else this.yesButton.node.active = false;
