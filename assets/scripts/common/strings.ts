...
export function getAccomplishments(pGameType : GAME_TYPE){
    ...
    switch(pGameType){
        case GAME_TYPE.EDUCATION :
            generalFacts = [
`أن مؤسسة القلب الكبير تقوم ببناء المدارس، وتقدم المنح <color=#b07221>هل تعلم</color>
الدراسية للطلاب، والتدريبات اللازمة للمعلمين، وتسهل حصول الأطفال على الفرص التعليمية؟`,
            
`هناك ﺃﻛﺜﺮ ﻣﻦ 15 ﻣﻠﻴﻮﻥ ﻃﺎﻟﺐ ﻓﻲ ﻣﻨﻄﻘﺔ ﺍﻟﺸﺮﻕ الأﻭﺳﻂ ﻏﻴﺮ ﻗﺎﺩﺭ ﻋﻠﻰ <color=#b07221>هل تعلم</color>
ﺍﻟﺬﻫﺎﺏ ﺇﻟﻰ ﺍﻟﻤﺪﺭﺳﺔ؟`,
...
؟ﺔﺸﻴﻌﻤﻟﺍ ﺕﺎﻳﻮﺘﺴﻣ ﻲﻧﺪﺗﻭ ﺕﺎﻋﺍﺰﻨﻟﺍ ﺏﺒﺴﺑ ﺔﻴﻠﺻﻷﺍ ﻢﻬﻧﺍﺪﻠﺑ ﻦﻣ ﺭﺍﺮﻔﻟﺍﻭ ﺮﻜﺒﻣ ﻦﺳ ﻲﻓ ﺔﺳﺭﺪﻤﻟﺍ`
            ...
            headings = [
                "حقائق عامة عن قطاع التعليم",
                "إنجازات مؤسسة القلب الكبير في قطاع التعليم"
            ];
            break;
...
؟ﺔﺻﺎﺨﻟﺍ ﺔﻳﺭﺎﺠﺘﻟﺍ ﻢﻬﻌﻳﺭﺎﺸﻣ ءﺎﺸﻧﺈﺑ ﻢﻬﻟ حﺎﻤﺴﻟﺍ ﻰﺘﺣ وﺃ ﻒﺋﺎﻇﻭ ﻢﻬﻟ ﺮﻓﻮﺘﺳ ﻲﺘﻟﺍ`
            ...
            headings = [
                "حقائق عامة عن قطاع تحسين المستوى المعيشي",
                "إنجازات مؤسسة القلب الكبير في قطاع تحسين المستوى المعيشي"
...
؟ءﺎﺑﻮﻟﺍ رﺎﺸﺘﻧﺍ ةﺮﺘﻓ لﻼﺧ ةﺪﺤﺘﻤﻟﺍ ﺔﻴﺑﺮﻌﻟﺍ تﺍﺭﺎﻣﻹﺍ ﻲﻓ ﻦﻴﻤﻴﻘﻤﻟﺍ ﻦﻣ ﺔﺟﺎﺘﺤﻣ ةﺮﺳﺃ`
            ...
            headings = [
                "ﺣﻘﺎﺋﻖ ﻋﺎﻣﺔ ﻋﻦ ﻗﻄﺎﻉ ﺍﻻﺳﺘﺠﺎﺑﺔ ﻟﺤﺎﻻﺕ ﺍﻟﻄﻮﺍﺭﺉ",
                "إنجازات مؤسسة القلب الكبير في قطاع الاستجابة لحالات الطوارئ"
            ];
            break;
...
ﺺﺨﺷ ﻒﻟﺃ 24 ﻢﻫﺩﺪﻋ ﻎﻟﺎﺒﻟﺍ ﻦﻴﺟﺎﺘﺤﻤﻟﺍﻭ ﻦﻴﺌﺟﻼﻟ ًﺎﻧﺎﺠﻣ جﻼﻌﻟﺍﻭ ﺔﻳﻭﺩﻻﺍ`               
            ...
            headings = [
                "حقائق عامة عن قطاع الرعاية الصحية",
                "ﺇﻧﺠﺎﺯﺍﺕ ﻣﺆﺳﺴﺔ ﺍﻟﻘﻠﺐ ﺍﻟﻜﺒﻴﺮ ﻓﻲ ﻗﻄﺎﻉ ﺍﻟﺮﻋﺎﻳﺔ ﺍﻟﺼﺤﻴﺔ"
            ];
            break;
        default : 
            generalFacts = [];
...
export function getVoiceOvers(pGameType : GAME_TYPE){
    ...
    switch(pGameType){
        case GAME_TYPE.EDUCATION :
            introduction =
`ﻥﺃ ﺪﻳﺮﺗ ﻲﺘﻟﺍ ﺔﻘﻳﺮﻄﻟﺍ ﺭﺎﺘﺨﻧ ﺎﻨﻋﺩ .ﻢﻴﻠﻌﺘﻟﺍ ﻉﺎﻄﻗ ﺭﺎﻴﺘﺧﺎﺑ ﺖﻤﻗ ﺪﻘﻟ
.ﺎﻬﺘﻌﻤﺟ ﻲﺘﻟﺍ ﺏﻮﻠﻘﻟﺎﺑ ﻉﺎﻄﻘﻟﺍ ﺍﺬﻫ ﺎﻬﺑ ﻢﻋﺪﺗ`;
            tutorial =
`.ﺔﺒﺳﺎﻨﻤﻟﺍ لﻭﺪﻟﺍ ﻰﻟﺇ ﺔﻣﺯﻼﻟﺍ تﺎﺟﺎﻴﺘﺣﻻﺍ لﺎﺼﻳﺇﻭ ﺐﺤﺴﺑ ﻢﻗ .ﻢﻫﺪﻋﺎﺳﻭ ﺪﻠﺑ ﻞﻛ تﺎﺟﺎﻴﺘﺣﻻ ﻪﺒﺘﻧﺍ
.ﻂﻘﻓ ةﺪﺣﺍﻭ ﺔﺟﺎﺣ ﻰﻠﻋ ﺰﻛﺮﺗ ﻻﺃ لﻭﺎﺣ !ﺔﻋﺮﺴﺑ فﺮﺼﺘﻟﺍ ﻰﻟﺇ ﺔﺟﺎﺤﺑ ﻦﺤﻧ !عﺮﺳﺃ`;
            end =
` ﺓﺪﻋﺎﺴﻤﻟ ﺏﻮﻠﻘﻟﺍ ﻦﻣ xxx ـﺑ ﺖﻋﺮﺒﺗ ﺪﻘﻟ ،ﺱﺎﻨﻟﺍ ﻦﻣ ﺮﻴﺜﻜﻟﺍ ﺕﺪﻋﺎﺳ ﺪﻘﻟ !ﺖﻨﺴﺣﺃ
.ﻢﻴﻠﻌﺘﻟﺍ ﻦﻣ ﺪﻴﺟ ﻯﻮﺘﺴﻣ ﻰﻠﻋ ﻝﻮﺼﺤﻠﻟ ﺓﺩﺪﻌﺘﻣ ﻥﺍﺪﻠﺑ ﻲﻓ ﻦﻴﺟﺎﺘﺤﻤﻟﺍ ﺏﻼﻄﻟﺍ`;
            game_summary =
`لقد استخدمت xxx  قلب لمساعدة الطلاب المحتاجين من  
:الحصول على مستوى جيد من التعليم في دول متعددة`     
break;
        case GAME_TYPE.LIVLIHOOD :
            introduction = 
`ﺕﺎﺟﺎﻴﺘﺣﻻﺍﺮﻴﻓﻮﺗ ﻲﻓ ﻢﻫﺎﺴﻧ ﺎﻧﻮﻋﺩ .ﻲﺸﻴﻌﻤﻟﺍ ﻯﻮﺘﺴﻤﻟﺍ ﻦﻴﺴﺤﺗ ﻉﺎﻄﻗ ﺕﺮﺘﺧﺍ ﺪﻘﻟ
.ﺔﻔﻌﻀﺘﺴﻤﻟﺍ ﺕﺎﻌﻤﺘﺠﻤﻠﻟ ﺔﻴﺳﺎﺳﻷﺍ`
            tutorial =
`ﻞﻴﻤﺤﺘﻟ ﺓﺪﺣﺍﻭ ﺔﻘﻴﻗﺩ ﻚﻳﺪﻟ ﻉﺮﺳﺃ ،ﺔﺤﻴﺤﺼﻟﺍ ﺔﻨﺣﺎﺸﻟﺍ ﻲﻓ ﻖﻳﺩﺎﻨﺼﻟﺍ ﻊﺿﻭﻭ ﺐﺤﺴﺑ ﻢﻗ
.ﺎﻬﻌﻤﺠﺑ ﺖﻤﻗ ﻲﺘﻟﺍ ﺏﻮﻠﻘﻟﺍ ﻡﺍﺪﺨﺘﺳﺎﺑ ﺔﻨﺣﺎﺷ ﻞﻜﻟ ﻦﻴﻗﻭﺪﻨﺻ`;

            end =
`ﺮﻴﻓﻮﺘﻟ ﺏﻮﻠﻘﻟﺍ ﻦﻣ xxxﺏ ﺖﻋﺮﺒﺗ ﺪﻘﻟ .ﺱﺎﻨﻟﺍ ﻦﻣ ﺮﻴﺜﻜﻟﺍ ﺕﺪﻋﺎﺳ ﺪﻘﻟ !ﺖﻨﺴﺣﺃ
.ﺔﺟﺎﺘﺤﻤﻟﺍ ﺕﺎﻌﻤﺘﺠﻤﻠﻟ ﺔﻣﺯﻼﻟﺍ ﺕﺎﻴﺳﺎﺳﻷﺍ`
            game_summary = 
`لقد استخدمت xxx قلب لتوفير الأساسيات اللازمة
:للمجتمعات المحتاجة`
            break;
        case GAME_TYPE.RELIEF :
            introduction = 
`ﺔﺛﺎﻏﻹﺍ ﻢﻳﺪﻘﺘﻟ نﻵﺍ ﺖﻗﻮﻟﺍ نﺎﺣ ،ئﺭﺍﻮﻄﻟﺍ تﻻﺎﺤﻟ ﺔﺑﺎﺠﺘﺳﻻﺍ عﺎﻄﻗ ﻲﻓ ﻢﻜﺑ ﺎًﺒﺣﺮﻣ
ﻢﺘﻴﻟ ﺔﻴﺛﺎﻏﺇ ﻖﻳﺩﺎﻨﺻ 5 ﻞﻘﻧ ﻲﻫ ﻚﺘﻤﻬﻣﻭ ،ﺔﻔﻌﻀﺘﺴﻤﻟﺍ تﺎﻌﻤﺘﺠﻤﻠﻟ ﺔﻴﻧﺎﺴﻧﻹﺍ
.ةﺮﺋﺎﻄﻟﺍ ﻲﻓ ﺎﻬﻨﺤﺷ`
            tutorial = "";
            end = 
`ﻢﻳﺪﻘﺘﻟ ﺏﻮﻠﻘﻟﺍ ﻦﻣ xxx ﺏ ﺖﻋﺮﺒﺗ ﺪﻘﻟ ،ﺱﺎﻨﻟﺍ ﻦﻣ ﺮﻴﺜﻜﻟﺍ ﺕﺪﻋﺎﺳ ﺪﻘﻟ !ﺖﻨﺴﺣﺃ
.ﻦﻴﺟﺎﺘﺤﻤﻠﻟ ﺔﻴﻧﺎﺴﻧﻹﺍ ﺔﺛﺎﻏﻹﺍ`
            game_summary =
`لقد استخدمت xxx قلب لتقديم الإغاثة الإنسانية
:للمحتاجين`;
            break;
        case GAME_TYPE.HEALTHCARE : 
            introduction = 
`،ﺔﻴﺤﺼﻟﺍ ﺔﻳﺎﻋﺮﻟﺍ ﻉﺎﻄﻗ ﻢﻋﺪﻟ ﺎﻬﻌﻤﺟ ﻢﺗ ﻲﺘﻟﺍ ﺏﻮﻠﻘﻟﺍ ﻡﺍﺪﺨﺘﺳﻻ ﻥﻵﺍ ﺖﻗﻮﻟﺍ ﻥﺎﺣ
...
`ﻢﻳﺪﻘﺘﻟ ﺏﻮﻠﻘﻟﺍ ﻦﻣ xxxﺏ ﺖﻋﺮﺒﺗ ﺪﻘﻟ .ﺱﺎﻨﻟﺍ ﻦﻣ ﺮﻴﺜﻜﻟﺍ ﺕﺪﻋﺎﺳ ﺪﻘﻟ !ﺖﻨﺴﺣﺃ
.ﺕﺎﻴﻔﺸﺘﺴﻤﻟﺍ ﻯﺪﺣﻹ ﺔﻴﻟﺎﻋ ﺓﺩﻮﺟ ﺕﺍﺫ ﺔﻴﺤﺻ ﺕﺎﻣﺪﺧ`
            game_summary =
`لقد استخدمت xxx قلب لتقديم خدمات صحية ذات
